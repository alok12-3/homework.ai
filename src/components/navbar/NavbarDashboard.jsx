...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 dark:bg-gray-900 pr-2 pl-2 fixed w-full z-10 top-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 rtl:space-x-reverse">
          ...
          <div className="hidden md:flex space-x-3 rtl:space-x-reverse"></div>
          <button
            onClick={toggleMenu}
